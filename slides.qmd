...
## How do people move in the city?
...
- The data is available to researchers (**Data4Good** Partner Program)
...
## Facebook Mobility Data
#### How do you convert user positions into a map?
...
- Data is provided in 8-hour time periods.
...
:::footer
Image source: [`quadkeyr` documentation](https://docs.ropensci.org/quadkeyr/)
::: 
...
1. A software package to convert Facebook Mobility data to raster images
2. A dashboard to provide a **quick overview of the situation**,
